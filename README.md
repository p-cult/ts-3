...
| 4 | **[SLICE-01.md](SLICE-01.md)** … **[SLICE-15.md](SLICE-15.md)** | Control room → live Sheets → admin inject |
...
- **Slice 01–15:** built + automated tests green (`npm test`) — Staging track + live Sheets read/write unlock; admin **Inject** (WhatsApp/JSON/CSV/TSV → birth hallway)
