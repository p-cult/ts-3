...
| 4 | **[SLICE-01.md](SLICE-01.md)** … **[SLICE-14.md](SLICE-14.md)** | Control room → live Sheets read/write path |
...
- **Slice 01–14:** built + automated tests green (`npm test`) — Staging track + live Sheets read; supervised write unlock
