...
**Status:** Foundation + Slice 01–15 built (`npm test` green). Staging track + live Sheets read; **supervised write** unlock (defaults still off); admin **Inject** tab; cutover via `./go-live.sh`.  
